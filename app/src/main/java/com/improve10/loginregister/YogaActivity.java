...
public class YogaActivity extends AppCompatActivity {
    ...
    private String[] asanaInformation = {
            "Om Mitraaya Namaha/" +
                    ...
                    "Expand your chest and relax your shoulders. Inhale while lifting both arms up. Exhale while bringing" +
                    " your palm together right in front of your chest in the namaste or prayer position." +
            ...
            "Om Khagaya Namaha"+
                    "\n"
                    +"While keeping the previous position in place, now stretch out your left leg backward," +
                    " keeping your hands perpendicular to the floor. This will bring your whole body in a line.",
            "Om Pooshne Namaha"+
                    "\n"+
                    "Remaining in the previous asana, exhale and slowly bring your knees down so they touch the floor." +
                    " Now take your hips back and slide forward resting your chest and chin on the floor.",

            "Om Hiranya Garbhaya Namaha"+
                    "Now slide forward and come into the cobra posture by raising your chest upward while you exhale. " +
                    "Keep the elbows bent and shoulders away from the ears. This posture gives a forward stretch to the body.",
            "Om Mareechaye Namaha"+
                    "To perform this step of Surya Namaskar, " +
                    "exhale and lift the hips upward bringing the body in the pose of inverted ‘V’",
            "Om Adityaaya Namaha"+
                    "This is the ninth out of 12 yoga poses of Surya Namaskar. To perform the Ashwasanchalana pose, " +
                    "inhale while stepping out your right foot forward and placing it rightly between the two hands and right calf perpendicular to the floor. Place the left knee on the floor. Raise your face and look up while pressing the hips down.\n"
            ,
            "Om Savitre Namaha"+
                    "Coming to the tenth pose of the 12 poses of Surya Namaskar, to perform hastapadasana, exhale and bring the left foot forward, placing the palms on the floor, you may try to touch your nose to the knees while performing " +
                    "this asana of Surya namaskar. Beginners can bend their knees if find necessary.",
            "Om Arkaaya Namaha"+
                    "Switching to the eleventh pose of Surya Namaskar postures, here you have to inhale while rolling up the spine. Gently raise both the hands up and backward making sure that your biceps are placed rightly close to the ears." +
                    " Push your hips outward to complete the pose efficiently.",
            "Om Bhaskaharaya Namaha"+
                    "\n"
                    +"This is the last of the twelve poses of Surya Namaskar. Exhale, straighten your body, bring both arms gently downwards." +
                    " Relax and encounter the serene sensation of your body."
    };
